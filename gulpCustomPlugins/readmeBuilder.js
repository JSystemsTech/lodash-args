(function(factory) {
    ...
    if (typeof exports == "object" && typeof require == "function") {
        module.exports = factory(require("lodash"),
            require("lodash-collection-helpers"),
            require("../devconfig"),
            require("../readme"));
    }
    // AMD
    else if (typeof define == "function" && define.amd) {
        define(["lodash", "lodash-collection-helpers", "../devconfig", "../readme"], factory);
    }
}(function(_, CollectionHelpers, devConfig, readmeDotJSON) {
    _.mixin(CollectionHelpers.getCollectionHelpers());
    
    var name = _.get(devConfig, 'sharedConfig.name', '');
    ...
    var getCoverageDetails = function() {
        ...
        var coverageDetails = _.select(coverageSummary, {
            'total.lines': 'lines',
        ...
        var tables = _.map(coverageDetails, function(details, key) {
            var formattedDetails = _.selectAll(details, {
                'pct': 'percent'
            });
    ...
    var compileToMdFormat = function(argument) {
        ...
        var description = '*' + _.get(devConfig, 'sharedConfig.description', '') + '*\n';
